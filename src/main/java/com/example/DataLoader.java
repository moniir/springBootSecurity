...
public class DataLoader {
    ...
    private void loadData(){
        ...
        // create an author
        Author dv = new Author("Monir","Hossain","monir198@gmail.com");
    ...
    private void createAuthors() {
        Author jv = new Author("Zubayer","Mridha","zubayer@gmail.com");
        authorRepository.save(jv);
        Author av = new Author("Mobinul","Islam","mobinul@gmail.com");
        authorRepository.save(av);
        Author kv = new Author("Jahurul","Islam","jahurul@gmail.com");
    ...
    private void createPosts(Author author) {
        ...
        Post post = new Post("Spring Data Test!");
        post.setSlug("spring-data-test");
        ...
        Post grails = new Post("spring boot is awesome!");
        grails.setSlug("spring-boot-is-awesome");
